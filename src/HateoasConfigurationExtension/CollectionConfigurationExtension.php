 ...
 * {@inheritDoc}
 */
class CollectionConfigurationExtension implements ConfigurationExtensionInterface
{
    /**
     * @var string
     */
    ...
    {
        return $classMetadata->getName() === CollectionRepresentation::class ||
            is_subclass_of($classMetadata->getName(), CollectionRepresentation::class);
    }
